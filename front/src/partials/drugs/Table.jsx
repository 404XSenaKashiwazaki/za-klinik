          ...
          <table className="table-auto w-full">
              ...
              <thead className="text-xs font-semibold uppercase text-slate-400 bg-slate-50">
                ...
                <th className="p-2 whitespace-nowrap ">
                  ...
                  <th className="p-2 whitespace-nowrap">
                    <div className="font-semibold text-left">Tanggal kadaluarsa</div>
                  </th>
                  <th className="p-2 whitespace-nowrap">
                ...
                data.length > 0 && data.map((d,index) => {
                  return (
                    <tr key={d.id}>
                      ...
                      <td className="p-2 whitespace-nowrap">
                        <div className="text-left font-medium ">{ d.stok }</div>
                      </td>
                      <td className="p-2 whitespace-nowrap">
                        <div className="text-left font-medium ">{ formatRp(d.harga) }</div>
                      </td>
                      <td className="p-2 whitespace-nowrap">
                        <div className="text-left font-medium ">
                          {  new Date(d?.tgl_kadaluarsa).toString().slice(0,25) }
                          <TimeAgo date={d.tgl_kadaluarsa} />
                        </div>
                      </td>
                      <td className="p-2 whitespace-nowrap">
