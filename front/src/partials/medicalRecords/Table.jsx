          ...
          <table className="table-auto w-full">
              ...
              <thead className="text-xs font-semibold uppercase text-slate-400 bg-slate-50">
                ...
                <th className="p-2 whitespace-nowrap ">
                  ...
                  <th className="p-2 whitespace-nowrap">
                    <div className="font-semibold text-left">keluhan</div>
                  </th>
                  <th className="p-2 whitespace-nowrap">
                    <div className="font-semibold text-left">Biaya</div>
                  </th>
                  <th className="p-2 whitespace-nowrap">
                    <div className="font-semibold text-left">keterangan</div>
                  </th>
                  <th className="p-2 whitespace-nowrap">
                    <div className="font-semibold text-left">Tanggal Periksa</div>
                  </th>
                  <th className="p-2 whitespace-nowrap">
                    ...
                    <tr key={d.id}>
                      ...
                      <td className="p-2 whitespace-nowrap">
                        <div className="flex items-center">
                          ...
                          <div className="font-medium text-slate-800">{d.keluhan}</div>
                        </div>
                      </td>
                      <td className="p-2 whitespace-nowrap">
                        <div className="text-left font-medium ">{ formatRp(d.biaya) }</div>
                      </td>
                      <td className="p-2 whitespace-nowrap">
                        <div className="text-left font-medium ">{ d.keterangan }</div>
                      </td>
                      <td className="p-2 whitespace-nowrap">
                        <div className="text-left font-medium ">
                          {  new Date(d?.tgl_periksa).toString().slice(0,25) }
                          <TimeAgo date={d.tgl_periksa} />
                        </div>
                      </td>
                      <td className="p-2 whitespace-nowrap">
